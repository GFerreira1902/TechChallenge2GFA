...
3. **Imputação Dinâmica Modular:** Preenchimento estatístico via interface das covariáveis com a mediana global do treino, focando a atenção humana apenas nas Top 5 features de maior impacto (*Feature Importance / SHAP*).
...
```
> **Observação** Se optar por não configurar a chave localmente, foi criado um tratamento em que a interface assumirá o comportamento de *Fallback Seguro*, assim então evitando erros na tela.
...
---
*Projeto elaborado para a Fase 2 do Tech Challenge - Pós-Graduação IA para Devs FIAP.*